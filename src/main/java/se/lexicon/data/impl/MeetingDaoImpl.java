    ...
    public Optional<Meeting> findById(int id) {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                return Optional.of(new Meeting(id, title, startTime.toLocalDateTime(), endTime.toLocalDateTime(), description,calendarId);
            }
        }
        catch (SQLException e) {
    ...
    public Collection<Meeting> findAllMeetingsByCalendarId (int calendarId) {
        ...
        try (
            ...
            while (resultSet.next()) {
                ...
                String description = resultSet.getString("description");
                meetings.add(new Meeting(id, title, startTime, endTime, description, calendarId));
            }
